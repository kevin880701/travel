...
import com.lhr.travel.data.activitys.Data
import com.lhr.travel.ui.web.WebActivity

class ActivitysAdapter(context: Context) : RecyclerView.Adapter<ActivitysAdapter.ViewHolder>() {
    var context = context
    var listData = ArrayList<Data>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_activitys, parent, false)
